...
def main(argv):
    inputfile = ''
    global domain,https,outputfile,tldfile
    try:
        opts, args = getopt.getopt(argv,"sd:o:i:")
    except getopt.GetoptError:
        print ('tld_scanner.py  [-d <domain>] [-o <outputfile>] [-i <tldfile>] [-s]')
        print ('')
		print ('This tool scanns for all possible TLDs of a given domain name')
		print ('')
        print ('-d <domain>     | Specifiy the domain name - without TLD or www, example: google')
...
if __name__ == '__main__':
    try:
        ...
        print("Using the following protocol(s):")
        print(protocols)
        if tldfile is not '':
            tlds = [line.rstrip('\n') for line in open(tldfile)]
            print("Using custom TLD List:")
            print(tlds)
        else:
